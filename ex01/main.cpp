...
int main()
{
    ...
    {
        std::cerr << RED << "constructor Bureaucrat 1 catch error : " << error << '\n' << RESET;
    }
    try
    {
    ...
    {
        std::cerr << RED << "constructor Bureaucrat 2 catch error : " << error << '\n' << RESET;
    }
    try
    {
    ...
    {
        std::cerr << RED << "constructor Bureaucrat 3 catch error : " << error << '\n' << RESET;
    }
	...
	{
        std::cerr << RED << "constructor Form 1 catch error : " << error << '\n' << RESET;
	}
	...
	{
        std::cerr << RED << "constructor Form 2 catch error : " << error << '\n' << RESET;
	}
	...
	{
        std::cerr << RED << "constructor Form 3 catch error : " << error << '\n' << RESET;
	}
	...
	{
        std::cerr << RED << "beSigned 1 catch error : " << error << '\n' << RESET;
	}
	...
	{
        std::cerr << RED << "beSigned 2 catch error : " << error << '\n' << RESET;
	}
